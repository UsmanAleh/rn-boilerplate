...
1. Clone the repository.
2. Create a new branch: `git checkout -b WL8-XXXX-your-ticket-title`
3. Commit your changes: `git commit -m 'feat(WL8-XXXX): Add new feature'`
4. Push the branch: `git push origin WL8-XXXX-your-ticket-title`
